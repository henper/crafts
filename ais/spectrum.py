...
fs, data = wav.read('/mnt/c/Projects/sdr/sdrsharp-x86/SDRSharp_20200301_102815Z_161425000Hz_IQ.wav', mmap=True)
...
zf = np.empty((len(yf), len(xf)), np.float) # matrix for FFT magnitudes
