...
for i in range(len(file_sizes)):
    unified += str(i) * int(file_sizes[i])
...
# Create list without the empty spaces, such that we have a list that we can pick file blocks from
files = unified.translate(str.maketrans({'.': None}))
